...
Enables a business to reverse a recent C2B transaction on the business account.
...
- The organization sends a reversal request via the Daraja API Gateway.
- The gateway authenticates and forwards the request to the M-PESA system.
- M-PESA processes the reversal, refunds the customer, sends an SMS notification, and returns the result through Daraja to the organization.
...
- Create a Daraja Account on the [Safaricom Developer Portal](https://developer.safaricom.co.ke).
